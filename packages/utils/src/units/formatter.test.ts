...
test('get the smallest number if the given number is smaller than required', () => {
...
test('removes tailing zero in fraction', () => {
...
test('adds comma to a number or amount string', () => {
